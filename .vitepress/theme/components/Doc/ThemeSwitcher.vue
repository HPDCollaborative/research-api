...
<template>
  <button
    type="button"
    @click="toggleDark()"
    class="rounded-lg p-2.5 text-sm text-surface-500 transition-colors duration-500 hover:text-primary-500 focus:outline-none focus:ring-0 dark:text-surface-400 dark:hover:text-primary-500"
